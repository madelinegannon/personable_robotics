...
//--------------------------------------------------------------
void Agent::set_pose(ofNode _pose){
    pose.setGlobalPosition(_pose.getGlobalPosition());
    pose.setGlobalOrientation(_pose.getGlobalOrientation());
    
    curr_pos = pose.getGlobalPosition();
    desired_pos = pose.getGlobalPosition();
}
